...
def main(q, debug):
    ...
    sequence_path = '/home/gilbertogonzalez/Downloads/KITTI_data_gray/dataset/sequences/09/image_0'
    ...
    vid = cv2.VideoCapture('/home/gilbertogonzalez/Downloads/blackfly_4.mp4')
    vid_frame = None
    prev_frame = None
